...
def run():
    ...
    from monai.losses import TverskyLoss, GeneralizedDiceLoss
    ...
    def objective(trial, train_loader, val_loader, device, random_seed, out_channels, epochs):
        with mlflow.start_run(nested=True):
            ...
            loss_function = GeneralizedDiceLoss(include_background=True, to_onehot_y=True, softmax=True)
    ...
    random_transforms = Compose([
        ...
        RandAffined(keys=["image", "label"], prob=0.5, rotate_range=(0.2, 0.2, 0.2), shear_range=(0.1, 0.1), scale_range=(0.1, 0.1), mode=("bilinear", "nearest")),
